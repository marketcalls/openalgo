...
| `strategy_module_rms.feature` | Multi-leg baskets, signal legs, durable ownership, pending stops, recovery/P&L authority, broker-primary UI truth | 34 |

Current totals:

- Feature files: 18
- Scenario definitions: 119
- Scenario outlines: 6
- Example rows across outlines: 106
- Expanded scenario cases: 219 (`119 - 6 + 106`)
