...
| Authentication, sessions, API keys | FR-008 to FR-014, FR-081 to FR-083 | `Security And Auth`, `Flask Blueprint Route Inventory` | `docs/bdd/auth_and_setup.feature`, `docs/bdd/broker_sessions.feature`, `docs/bdd/orders_and_action_center.feature`, `docs/bdd/session_lifecycle.feature` |
...
| REST API surface | FR-020 to FR-022 | `RESTX API V1`, `RESTX Endpoint Inventory`, `Request Schema Notes` | `docs/bdd/rest_api_inventory.feature` plus behavior features for orders, account, market data, GTT, and notifications |
...
| Positions, holdings, funds, margin | FR-033 to FR-035 | `RESTX Endpoint Inventory`, `Flask Blueprint Route Inventory`, `Analyzer And Sandbox` | `docs/bdd/account_and_depth.feature`, `docs/bdd/sandbox_analyzer.feature` |
| GTT orders | FR-036 to FR-039 | `GTT Orders` | `docs/bdd/gtt_orders.feature` |
| Market data, history, options | FR-040 to FR-047 | `Market Data And History`, `Data Stores`, `RESTX Endpoint Inventory`, `Flask Blueprint Route Inventory` | `docs/bdd/market_data.feature`, `docs/bdd/account_and_depth.feature`, `docs/bdd/historify_and_tools.feature` |
...
| Strategy module and RMS | `strategy-module-rms.md` FR1.1-FR1.6, FR2.1-FR2.15, FR3.1-FR3.5, FR4.1-FR4.6, FR5.1-FR5.10, FR6.1-FR6.3, FR7.1-FR7.10, FR8.1-FR8.10 (65 functional) plus NFR1-NFR7 | `Automation Surfaces`, `Flask Blueprint Route Inventory`, `RESTX Endpoint Inventory`; module implementation and API docs are the detailed contract | `docs/bdd/strategy_module_rms.feature` (35 scenarios covering configuration, durable intent/ack, fill idempotency, exact ownership, aggregate-trigger versus execution truth, confirmed-flat stopping, recovery/P&L authority, streaming and broker-primary UI truth) |
| Scalping, analytics, placeholders | FR-084 to FR-089 | Flask route inventory plus current module sources | `docs/bdd/scalping_and_tools.feature`, `docs/bdd/notifications_observability.feature` |
| Broker matrix | Broker support section | `Broker Plugins`, `Broker Matrix` | `docs/bdd/broker_sessions.feature`, `docs/bdd/broker_plugin_inventory.feature` |
