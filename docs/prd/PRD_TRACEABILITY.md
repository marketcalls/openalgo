...
| Strategy module and RMS | `strategy-module-rms.md` FR1.1-FR1.6, FR2.1-FR2.14, FR3.1-FR3.5, FR4.1-FR4.5, FR5.1-FR5.10, FR6.1-FR6.3, FR7.1-FR7.10, FR8.1-FR8.9 (62 functional) plus NFR1-NFR7 | `Automation Surfaces`, `Flask Blueprint Route Inventory`, `RESTX Endpoint Inventory`; module implementation and API docs are the detailed contract | `docs/bdd/strategy_module_rms.feature` (34 scenarios covering configuration, durable intent/ack, fill idempotency, exact ownership, shared risk, confirmed-flat stopping, recovery/P&L authority, streaming and broker-primary UI truth) |
