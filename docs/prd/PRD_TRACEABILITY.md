...
| Strategy module and RMS | `strategy-module-rms.md` FR1 to FR8 | `Automation Surfaces`, `Flask Blueprint Route Inventory`, `RESTX Endpoint Inventory` | `docs/bdd/strategy_module_rms.feature` |
