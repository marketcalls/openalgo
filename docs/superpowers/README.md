...
| Doc | What it covers |
|-----|----------------|
| [`specs/2026-07-13-global-market-architecture-design.md`](specs/2026-07-13-global-market-architecture-design.md) | The full target architecture — the six design sections, principles, and best practices. **Start here.** |
