...
def start_bot():
    ...
    try:
        ...
        # Validate and store the token. One bounded getMe request on the shared
        # HTTP client, the same in every runtime; it never touches a running
        # bot and never sets an asyncio loop on this request thread.
