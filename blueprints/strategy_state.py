...
def get_strategy_states():
    ...
    try:
        ...
        for state in states:
            # Calculate total realized P&L from legs
            ...
            for leg_key, leg in legs.items():
                ...
                elif leg_status in ['DONE', 'EXITED_WAITING_REENTRY', 'EXITED_WAITING_REEXECUTE']:
                    exited_positions_count += 1
            
            # Also sum P&L from trade history for more accurate totals
