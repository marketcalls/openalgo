    ...
    try:
        ...
        for s in get_user_strategies(user_id):
            ...
            strategies_data.append({
                ...
                "auto_squareoff_time": getattr(s, "auto_squareoff_time", None),
                # Risk defaults
                "default_stoploss_type": s.default_stoploss_type,
                "default_stoploss_value": s.default_stoploss_value,
                "default_target_type": s.default_target_type,
                "default_target_value": s.default_target_value,
                "default_trailstop_type": s.default_trailstop_type,
                "default_trailstop_value": s.default_trailstop_value,
                "default_breakeven_type": s.default_breakeven_type,
                "default_breakeven_threshold": s.default_breakeven_threshold,
                "default_exit_execution": getattr(s, "default_exit_execution", "market"),
                # Daily circuit breaker
                "daily_stoploss_type": getattr(s, "daily_stoploss_type", None),
                "daily_stoploss_value": getattr(s, "daily_stoploss_value", None),
                "daily_target_type": getattr(s, "daily_target_type", None),
                "daily_target_value": getattr(s, "daily_target_value", None),
                "daily_trailstop_type": getattr(s, "daily_trailstop_type", None),
                "daily_trailstop_value": getattr(s, "daily_trailstop_value", None),
                # Live aggregated
                ...
                "trade_count_today": metrics.get("total_trades", 0),
                "order_count": 0,
        ...
        for s in get_chartink_strategies(user_id):
            ...
            strategies_data.append({
                ...
                "webhook_id": getattr(s, "webhook_id", ""),
                "platform": getattr(s, "platform", "chartink"),
                "is_active": s.is_active,
                "is_intraday": getattr(s, "is_intraday", True),
                "risk_monitoring": getattr(s, "risk_monitoring", "active"),
                "trading_mode": getattr(s, "trading_mode", "LONG"),
                "auto_squareoff_time": getattr(s, "auto_squareoff_time", None),
                # Risk defaults
                "default_stoploss_type": getattr(s, "default_stoploss_type", None),
                "default_stoploss_value": getattr(s, "default_stoploss_value", None),
                "default_target_type": getattr(s, "default_target_type", None),
                "default_target_value": getattr(s, "default_target_value", None),
                "default_trailstop_type": getattr(s, "default_trailstop_type", None),
                "default_trailstop_value": getattr(s, "default_trailstop_value", None),
                "default_breakeven_type": getattr(s, "default_breakeven_type", None),
                "default_breakeven_threshold": getattr(s, "default_breakeven_threshold", None),
                "default_exit_execution": getattr(s, "default_exit_execution", "market"),
                # Daily circuit breaker
                "daily_stoploss_type": getattr(s, "daily_stoploss_type", None),
                "daily_stoploss_value": getattr(s, "daily_stoploss_value", None),
...
RISK_FIELDS = {
    ...
    # Daily circuit breaker
    "daily_stoploss_type", "daily_stoploss_value",
    "daily_target_type", "daily_target_value",
    "daily_trailstop_type", "daily_trailstop_value",
}
