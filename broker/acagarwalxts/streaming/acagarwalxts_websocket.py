...
from broker.acagarwalxts.baseurl import BASE_URL, INTERACTIVE_URL, MARKET_DATA_URL
from utils.logging import get_logger


class AcagarwalXTSWebSocketClient:
    """
    AcagarwalXTS Socket.IO client for market data streaming
    ...
    def __init__(self, api_key: str, api_secret: str, user_id: str, base_url: str = None):
        """
        Initialize the AcagarwalXTS Socket.IO client
    ...
    def connect(self):
        ...
        try:
            ...
            self.logger.info(f"Connecting to AcagarwalXTS Socket.IO: {connection_url}")
            ...
            self.logger.error(f"Failed to connect to AcagarwalXTS Socket.IO: {e}")
            if self.on_error:
    ...
    def disconnect(self):
        ...
        self.logger.info("Disconnected from AcagarwalXTS Socket.IO")
    ...
    def _on_connect(self):
        ...
        self.connected = True
        self.logger.info("Connected to AcagarwalXTS Socket.IO")
