...
from broker.deltaexchange_demo.streaming.delta_websocket import DeltaWebSocket
from broker.deltaexchange_demo.streaming.delta_mapping import (
...
class DeltaWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def __init__(self):
        ...
        self.ws_client    = None
        self.user_id      = None
        self.broker_name  = "deltaexchange_demo"
        self.running      = False
    ...
    def _handle_private_event(self, event_type: str, msg: dict) -> None:
        ...
        OpenAlgo service can subscribe to them via ZeroMQ:
          ...
          Topic pattern: ``deltaexchange_demo_{event_type}``
          Examples:      ``deltaexchange_demo_orders``, ``deltaexchange_demo_positions``,
                         ``deltaexchange_demo_margins``
        ...
        """
        topic = f"{self.broker_name}_{event_type}"
        payload = dict(msg)
