...
def authenticate_broker(totp_code):
    ...
    if not phone or not mpin:
        return None, None, "Missing BROKER_API_KEY (phone) or BROKER_API_SECRET (mpin) in environment"
    ...
    try:
        ...
        totp_response = client.post(
            ...
            json=totp_login_payload,
            headers=totp_login_headers
        )
        ...
        pin_response = client.post(
            ...
            json=verify_pin_payload,
            headers=verify_pin_headers
        )
