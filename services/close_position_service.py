...
def close_position_with_auth(
    ...
    if status_code == 200:
        ...
        # Note: Use original_data to get apikey because broker module may overwrite position_data['apikey']
        telegram_alert_service.send_order_alert('closeposition', position_data, response_data, original_data.get('apikey'))
        return True, response_data, 200
    else:
