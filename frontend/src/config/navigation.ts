...
export const profileMenuItems: NavItem[] = [
  ...
  { href: '/ml-advisor', label: 'ML Advisor', icon: Brain },
  { href: '/aaum-advisor', label: 'AAUM Intelligence', icon: Sparkles },
  { href: '/ai-analyzer', label: 'AI Analysis', icon: TrendingUp },
  { href: '/institutional-dashboard', label: 'AAUM Dashboard', icon: Target },
