...
import { Copy, RefreshCw, AlertTriangle, BookOpen, ExternalLink } from 'lucide-react';
...
export default function TradingView() {
  ...
  // Get webhook URL
  const webhookUrl = `${window.location.origin}/api/v1/placesmartorder`;
  ...
  useEffect(() => {
    generateJson(false);
  }, [symbol, exchange, product, action, quantity, alertMode]);
