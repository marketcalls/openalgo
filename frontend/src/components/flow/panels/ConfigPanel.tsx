...
import { flowQueryKeys, getWebhookInfo } from '@/api/flow'
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleDataChange('quantity', parseInt(e.target.value, 10) || 1)}
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-[10px] text-muted-foreground">Use {`{{orderResult.orderid}}`}</p>
              </div>
            </>
          )}
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleDataChange('positionSize', parseInt(e.target.value, 10) || 0)
                  }
                />
                <p className="text-[10px] text-muted-foreground">
                  Target position size (0 = use quantity)
                </p>
              </div>
              <div className="space-y-2">
                <Label className="text-xs">Product</Label>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => {
                    ...
                    if (s) {
                      handleDataChange('quantity', s.lotSize)
                  ...
                  <SelectContent>
                    {INDEX_SYMBOLS.map((s) => (
                      <SelectItem key={s.value} value={s.value}>
                        {s.label} ({s.exchange}, Lot: {s.lotSize})
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleDataChange('splitSize', parseInt(e.target.value, 10) || 10)
                  }
                />
              </div>
              <div className="space-y-2">
              ...
              <p className="text-[10px] text-muted-foreground">
                Splits into{' '}
                {Math.ceil(
                  ((nodeData.quantity as number) || 100) / ((nodeData.splitSize as number) || 10)
                )}{' '}
                orders
              </p>
            </>
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleDataChange('outputVariable', e.target.value)}
                />
                <p className="text-[10px] text-muted-foreground">Use {`{{depth.bids[0].price}}`}</p>
              </div>
            </>
          )}
          ...
          {nodeType === 'waitUntil' && (
            <>
              <div className="space-y-2">
                ...
                />
                <p className="text-[10px] text-muted-foreground">Workflow pauses until this time</p>
              </div>
              <div className="space-y-2">
                <Label className="text-xs">Label</Label>
                <Input
                ...
                <div className="rounded-lg border bg-muted/30 p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">{nodeInfo.description}</p>
                    </div>
                  </div>
                </div>
              )}
