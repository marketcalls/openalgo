      ...
      <ScrollArea className="flex-1">
        <div className="space-y-4 p-4">
          ...
          {nodeType === 'placeOrder' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Quantity</Label><Input type="number" min={1} className="h-8" value={(nodeData.quantity as number) || 1} onChange={(e) => handleDataChange('quantity', parseInt(e.target.value) || 1)} /></div>
          ...
          {nodeType === 'smartOrder' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Action</Label><div className="grid grid-cols-2 gap-2">{ORDER_ACTIONS.map((a) => (<button key={a.value} type="button" onClick={() => handleDataChange('action', a.value)} className={cn('rounded-lg border py-2 text-sm font-semibold', nodeData.action === a.value ? a.value === 'BUY' ? 'bg-green-500/20 border-green-500 text-green-600' : 'bg-red-500/20 border-red-500 text-red-600' : 'border-border bg-muted')}>{a.label}</button>))}</div></div>
            <div className="space-y-2"><Label className="text-xs">Quantity</Label><Input type="number" min={1} className="h-8" value={(nodeData.quantity as number) || 1} onChange={(e) => handleDataChange('quantity', parseInt(e.target.value) || 1)} /></div>
            <div className="space-y-2"><Label className="text-xs">Position Size</Label><Input type="number" min={0} className="h-8" value={(nodeData.positionSize as number) || 0} onChange={(e) => handleDataChange('positionSize', parseInt(e.target.value) || 0)} /><p className="text-[10px] text-muted-foreground">Target position size (0 = use quantity)</p></div>
            <div className="space-y-2"><Label className="text-xs">Product</Label><Select value={(nodeData.product as string) || 'MIS'} onValueChange={(v) => handleDataChange('product', v)}><SelectTrigger className="h-8"><SelectValue /></SelectTrigger><SelectContent>{PRODUCT_TYPES.map((t) => (<SelectItem key={t.value} value={t.value}>{t.label}</SelectItem>))}</SelectContent></Select></div>
          ...
          {nodeType === 'optionsOrder' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Action</Label><div className="grid grid-cols-2 gap-2">{ORDER_ACTIONS.map((a) => (<button key={a.value} type="button" onClick={() => handleDataChange('action', a.value)} className={cn('rounded-lg border py-2 text-sm font-semibold', nodeData.action === a.value ? a.value === 'BUY' ? 'bg-green-500/20 border-green-500 text-green-600' : 'bg-red-500/20 border-red-500 text-red-600' : 'border-border bg-muted')}>{a.label}</button>))}</div></div>
            <div className="space-y-2"><Label className="text-xs">Quantity (Lots)</Label><Input type="number" min={1} className="h-8" value={(nodeData.quantity as number) || 75} onChange={(e) => handleDataChange('quantity', parseInt(e.target.value) || 1)} /></div>
          ...
          {nodeType === 'optionsMultiOrder' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Quantity (Lots)</Label><Input type="number" min={1} className="h-8" value={(nodeData.quantity as number) || 1} onChange={(e) => handleDataChange('quantity', parseInt(e.target.value) || 1)} /></div>
            <div className="space-y-2"><Label className="text-xs">Product</Label><Select value={(nodeData.product as string) || 'MIS'} onValueChange={(v) => handleDataChange('product', v)}><SelectTrigger className="h-8"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="MIS">MIS</SelectItem><SelectItem value="NRML">NRML</SelectItem></SelectContent></Select></div>
          ...
          {nodeType === 'basketOrder' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Orders (SYMBOL,EXCHANGE,ACTION,QTY)</Label><Textarea className="min-h-[100px] text-xs font-mono" placeholder="RELIANCE,NSE,BUY,10&#10;INFY,NSE,BUY,5" value={(nodeData.orders as string) || ''} onChange={(e) => handleDataChange('orders', e.target.value)} /></div>
            <div className="space-y-2"><Label className="text-xs">Product</Label><Select value={(nodeData.product as string) || 'MIS'} onValueChange={(v) => handleDataChange('product', v)}><SelectTrigger className="h-8"><SelectValue /></SelectTrigger><SelectContent>{PRODUCT_TYPES.map((t) => (<SelectItem key={t.value} value={t.value}>{t.label}</SelectItem>))}</SelectContent></Select></div>
            <div className="space-y-2"><Label className="text-xs">Output Variable</Label><Input className="h-8" placeholder="basketResult" value={(nodeData.outputVariable as string) || ''} onChange={(e) => handleDataChange('outputVariable', e.target.value)} /></div>
          </>)}
          ...
          {nodeType === 'splitOrder' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Exchange</Label><Select value={(nodeData.exchange as string) || 'NSE'} onValueChange={(v) => handleDataChange('exchange', v)}><SelectTrigger className="h-8"><SelectValue /></SelectTrigger><SelectContent>{EXCHANGES.map((e) => (<SelectItem key={e.value} value={e.value}>{e.label}</SelectItem>))}</SelectContent></Select></div>
            <div className="space-y-2"><Label className="text-xs">Action</Label><div className="grid grid-cols-2 gap-2">{ORDER_ACTIONS.map((a) => (<button key={a.value} type="button" onClick={() => handleDataChange('action', a.value)} className={cn('rounded-lg border py-2 text-sm font-semibold', nodeData.action === a.value ? a.value === 'BUY' ? 'bg-green-500/20 border-green-500 text-green-600' : 'bg-red-500/20 border-red-500 text-red-600' : 'border-border bg-muted')}>{a.label}</button>))}</div></div>
            <div className="space-y-2"><Label className="text-xs">Total Quantity</Label><Input type="number" min={1} className="h-8" value={(nodeData.quantity as number) || 100} onChange={(e) => handleDataChange('quantity', parseInt(e.target.value) || 100)} /></div>
            <div className="space-y-2"><Label className="text-xs">Split Size</Label><Input type="number" min={1} className="h-8" value={(nodeData.splitSize as number) || 10} onChange={(e) => handleDataChange('splitSize', parseInt(e.target.value) || 10)} /></div>
            <div className="space-y-2"><Label className="text-xs">Product</Label><Select value={(nodeData.product as string) || 'MIS'} onValueChange={(v) => handleDataChange('product', v)}><SelectTrigger className="h-8"><SelectValue /></SelectTrigger><SelectContent>{PRODUCT_TYPES.map((t) => (<SelectItem key={t.value} value={t.value}>{t.label}</SelectItem>))}</SelectContent></Select></div>
            <p className="text-[10px] text-muted-foreground">Splits into {Math.ceil(((nodeData.quantity as number) || 100) / ((nodeData.splitSize as number) || 10))} orders</p>
          </>)}
          ...
          {nodeType === 'modifyOrder' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">New Quantity</Label><Input type="number" min={1} className="h-8" placeholder="Leave empty to keep" value={(nodeData.newQuantity as number) || ''} onChange={(e) => handleDataChange('newQuantity', parseInt(e.target.value) || 0)} /></div>
          </>)}
          ...
          {nodeType === 'history' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Days</Label><Input type="number" min={1} max={365} className="h-8" value={(nodeData.days as number) || 30} onChange={(e) => handleDataChange('days', parseInt(e.target.value) || 30)} /></div>
          ...
          {nodeType === 'optionChain' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Exchange</Label><Select value={(nodeData.exchange as string) || 'NSE_INDEX'} onValueChange={(v) => handleDataChange('exchange', v)}><SelectTrigger className="h-8"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="NSE_INDEX">NSE Index</SelectItem><SelectItem value="BSE_INDEX">BSE Index</SelectItem></SelectContent></Select></div>
            <div className="space-y-2"><Label className="text-xs">Expiry Date</Label><Input className="h-8" placeholder="30DEC25" value={(nodeData.expiryDate as string) || ''} onChange={(e) => handleDataChange('expiryDate', e.target.value)} /></div>
            <div className="space-y-2"><Label className="text-xs">Strike Count</Label><Input type="number" className="h-8" placeholder="10 (empty=full)" value={(nodeData.strikeCount as number) || ''} onChange={(e) => handleDataChange('strikeCount', parseInt(e.target.value) || undefined)} /></div>
          ...
          {nodeType === 'holidays' && (<>
            <div className="space-y-2"><Label className="text-xs">Year</Label><Input type="number" className="h-8" placeholder={String(new Date().getFullYear())} value={(nodeData.year as number) || ''} onChange={(e) => handleDataChange('year', parseInt(e.target.value) || undefined)} /><p className="text-[10px] text-muted-foreground">Empty = current year</p></div>
          ...
          {/* ===== UTILITY NODES ===== */}
          {nodeType === 'delay' && (<>
            <div className="space-y-2"><Label className="text-xs">Wait Duration</Label><div className="flex gap-2"><Input type="number" min={1} className="h-8 flex-1" value={(nodeData.delayValue as number) || 1} onChange={(e) => handleDataChange('delayValue', parseInt(e.target.value) || 1)} /><Select value={(nodeData.delayUnit as string) || 'seconds'} onValueChange={(v) => handleDataChange('delayUnit', v)}><SelectTrigger className="h-8 w-28"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="seconds">Seconds</SelectItem><SelectItem value="minutes">Minutes</SelectItem><SelectItem value="hours">Hours</SelectItem></SelectContent></Select></div></div>
          </>)}
          ...
          {nodeType === 'httpRequest' && (<>
            ...
            <div className="space-y-2"><Label className="text-xs">Timeout (ms)</Label><Input type="number" min={1000} max={60000} className="h-8" value={(nodeData.timeout as number) || 30000} onChange={(e) => handleDataChange('timeout', parseInt(e.target.value) || 30000)} /></div>
          ...
          {nodeType === 'andGate' && (<>
            <div className="space-y-2"><Label className="text-xs">Number of Inputs</Label><Select value={String((nodeData.inputCount as number) || 2)} onValueChange={(v) => handleDataChange('inputCount', parseInt(v))}><SelectTrigger className="h-8"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="2">2 inputs</SelectItem><SelectItem value="3">3 inputs</SelectItem><SelectItem value="4">4 inputs</SelectItem><SelectItem value="5">5 inputs</SelectItem></SelectContent></Select></div>
