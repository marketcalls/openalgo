...
describe('ViewModeToggle', () => {
  it.each([
  ...
  ])('shows $initialMode as selected and changes to $expectedMode', async ({
    initialMode,
    selectedLabel,
    otherLabel,
    expectedMode,
    ...
    render(<ViewModeToggle viewMode={initialMode} onViewModeChange={onViewModeChange} />)

    expect(screen.getByRole('group', { name: 'Chain view mode' })).toBeInTheDocument()
