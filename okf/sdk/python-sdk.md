---
type: Reference
title: OpenAlgo Python SDK
description: Official OpenAlgo Python SDK covering install, client setup, and data, order, account, and indicator functions
resource: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/openalgo%20python%20sdk.md
tags:
- python
- sdk
- api-client
...
Please refer to the [order constants](order-constants.md) reference and the [symbol format](symbol-format.md) reference, and consult the API reference for details on optional parameters. See also the [PlaceOrder](../api/order-management/placeorder.md) and [History](../api/market-data/history.md) API endpoints.
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/openalgo%20python%20sdk.md
