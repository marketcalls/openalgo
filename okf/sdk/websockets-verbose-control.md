...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/websockets-verbose-control.md
tags:
- websocket
- logging
- verbose
...
See the [WebSocket protocol](websockets-format.md) reference for the subscription and message format, and the [Python SDK](python-sdk.md) for the streaming client API.
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/websockets-verbose-control.md
