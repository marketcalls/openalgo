...
* **Update**: Corrected the [Python SDK](sdk/python-sdk.md) install to a single `pip install openalgo`, and documented the [indicator library](indicators/introduction.md) as a Rust-backed PyO3 extension bundled in the base package — there is no indicators extra and there are no optional dependencies.
