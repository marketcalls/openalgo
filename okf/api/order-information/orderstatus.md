...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-information/orderstatus.md
tags:
- order-information
- orders
- status
...
The `action`, `pricetype`, and `product` values are documented in [Order Constants](../../sdk/order-constants.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-information/orderstatus.md
