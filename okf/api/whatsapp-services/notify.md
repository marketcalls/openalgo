...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/whatsapp-services/notify.md
tags:
- whatsapp
- notify
- alerts
...
script is exposed here. See the [WhatsApp Services overview](./overview.md)
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/whatsapp-services/notify.md
