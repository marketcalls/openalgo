...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/placesmartorder.md
tags:
- order
- smart-order
- position
...
- **Rate Limit**: 2 requests per second (more restrictive due to complexity). See [rate limiting](../rate-limiting.md) for details.

# Citations
- Official docs: https://docs.openalgo.in
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/placesmartorder.md
