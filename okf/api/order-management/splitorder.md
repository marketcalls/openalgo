...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/splitorder.md
tags:
- order
- split
- execution
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/splitorder.md
