...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/optionsmultiorder.md
tags:
- order
- options
- multi-leg
...
See [order code constants](../../sdk/order-constants.md) for valid `exchange`, `action`, `pricetype`, `product`, and `option_type` values. Each resolved leg symbol follows the [symbol format](../../sdk/symbol-format.md) convention.
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/optionsmultiorder.md
