...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/cancelallorder.md
tags:
- order
- cancel
- bulk
...
- [CancelOrder](./cancelorder.md) - Cancel a specific open order by order id
- [ClosePosition](./closeposition.md) - Close all open positions

# Citations
- Official docs: https://docs.openalgo.in
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/cancelallorder.md
