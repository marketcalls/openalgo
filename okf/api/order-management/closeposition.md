...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/closeposition.md
tags:
- position
- close
- square-off
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/closeposition.md
