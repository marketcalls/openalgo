...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/optionsorder.md
tags:
- order
- options
- atm-offset
...
See [order code constants](../../sdk/order-constants.md) for valid `exchange`, `action`, `pricetype`, `product`, and `option_type` values. The resolved option symbol follows the [symbol format](../../sdk/symbol-format.md) convention.
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/order-management/optionsorder.md
