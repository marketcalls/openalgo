...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/market-data/depth.md
tags:
- market-data
- depth
- order-book
...
Get market depth (Level 2 data) for a [symbol](../../sdk/symbol-format.md) showing top 5 bid and ask prices with quantities.
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/market-data/depth.md
