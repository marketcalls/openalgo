...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/market-calendar/holidays.md
tags:
- calendar
- holidays
- market
...
- [CheckHoliday](checkholiday.md) - Check whether a given date is a market holiday

# Citations
- Official docs: https://docs.openalgo.in
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/market-calendar/holidays.md
