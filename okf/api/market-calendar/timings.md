...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/market-calendar/timings.md
tags:
- calendar
- timings
- market-hours
...
- To confirm whether a date is closed before checking timings, use [CheckHoliday](checkholiday.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/market-calendar/timings.md
