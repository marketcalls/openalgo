...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/funds.md
tags:
- account
- funds
- margin
...
- To estimate the margin a prospective order would block before placing it, use [Margin](margin.md).

# Citations
- Official docs: https://docs.openalgo.in
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/funds.md
