...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/positionbook.md
tags:
- positions
- account
- pnl
...
The `product` value follows the standard [order constants](../../sdk/order-constants.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/positionbook.md
