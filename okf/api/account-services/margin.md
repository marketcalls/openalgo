...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/margin.md
tags:
- margin
- account
- risk
...
The `symbol`, `exchange`, `action`, `product`, and `pricetype` values inside each
position object follow the standard [order constants](../../sdk/order-constants.md)
and [symbol format](../../sdk/symbol-format.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/margin.md
