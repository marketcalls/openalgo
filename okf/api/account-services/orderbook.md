...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/orderbook.md
tags:
- orders
- account
- orderbook
...
The `action`, `pricetype`, and `product` values follow the standard
...
- For only the executed fills of these orders, see [TradeBook](tradebook.md).

# Citations
- Official docs: https://docs.openalgo.in
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/orderbook.md
