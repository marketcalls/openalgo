...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/tradebook.md
tags:
- trades
- account
- tradebook
...
The `action` and `product` values follow the standard
...
| Aspect | [OrderBook](orderbook.md) | TradeBook |
|--------|-----------|-----------|
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/account-services/tradebook.md
