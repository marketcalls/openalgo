...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/options-services/syntheticfuture.md
tags:
- options
- synthetic-future
- put-call-parity
...
- **Options pricing**: Use as underlying for options Greeks calculation via [OptionGreeks](optiongreeks.md)

# Citations
- Official docs: https://docs.openalgo.in
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/options-services/syntheticfuture.md
