...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/expiry.md
tags:
- symbol
- expiry
- futures
...
Get available expiry dates for a futures or options symbol. The `symbol` input uses the OpenAlgo [symbol format](../../sdk/symbol-format.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/expiry.md
