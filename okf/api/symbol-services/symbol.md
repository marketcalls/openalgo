...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/symbol.md
tags:
- symbol
- reference-data
- broker-mapping
...
Get detailed information about a specific trading symbol including broker-specific symbol mapping. The `symbol` input uses the OpenAlgo [symbol format](../../sdk/symbol-format.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/symbol.md
