...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/instruments.md
tags:
- symbol
- instruments
- master-contract
...
Get the complete list of instruments/symbols available for trading. Can be filtered by exchange. Every entry carries an OpenAlgo `symbol` in the standard [symbol format](../../sdk/symbol-format.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/instruments.md
