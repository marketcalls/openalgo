...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/search.md
tags:
- symbol
- search
- reference-data
...
Search for symbols by name, strike price, expiry, or other criteria. Results are returned in the OpenAlgo [symbol format](../../sdk/symbol-format.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/api/symbol-services/search.md
