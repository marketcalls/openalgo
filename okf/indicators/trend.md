...
resource: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/indicators/trend%20-%20openalgo%20indicators.md
tags:
- indicators
- trend
- moving-average
...
Trend indicators help identify the direction and strength of market trends. All examples use real market data fetched via the [History API](../api/market-data/history.md) through the [Python SDK](../sdk/python-sdk.md).
...
> The same DataFrame (`df`) is reused for every example below.
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/indicators/trend%20-%20openalgo%20indicators.md
