...
description: Statistical indicators including Linear Regression, Linear Regression Slope, Correlation, Beta, Variance, Time Series Forecast, Rolling Median, Median Bands and Rolling Mode
resource: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/indicators/statistical%20-%20openalgo%20indicators.md
tags:
- indicators
- statistical
- linear-regression
...
Statistical indicators analyze price data using mathematical and statistical methods to identify patterns, relationships, and forecast future price movements. Market data is fetched via the [History API](../api/market-data/history.md) through the [Python SDK](../sdk/python-sdk.md).
...
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/indicators/statistical%20-%20openalgo%20indicators.md
