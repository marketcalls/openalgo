...
description: Volume indicators including OBV, VWAP, MFI, ADL, CMF, EMV, Force Index, NVI, PVI, Volume Oscillator, VROC, Klinger Volume Oscillator, PVT and RVOL
resource: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/indicators/volume%20-%20openalgo%20indicators.md
tags:
- indicators
- volume
- obv
...
Volume indicators analyze trading volume to assess the strength of price movements and identify potential trend changes. These indicators help determine whether price movements are supported by volume activity. Data is fetched via the [History API](../api/market-data/history.md) through the [Python SDK](../sdk/python-sdk.md).
...
- [Technical Indicators Introduction](introduction.md)

# Citations
- Official docs: https://docs.openalgo.in
- Source: https://github.com/marketcalls/openalgo/blob/main/docs/prompt/indicators/volume%20-%20openalgo%20indicators.md
