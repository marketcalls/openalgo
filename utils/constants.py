...
# Required Fields for Bracket Order
REQUIRED_BRACKET_ORDER_FIELDS = [
    "apikey", "strategy", "symbol", "exchange", "action", "quantity",
    "target_type", "target_value", "sl_type", "sl_value",
]

# Bracket Order States
BO_STATE_CREATED = "CREATED"
BO_STATE_ENTRY_PENDING = "ENTRY_PENDING"
BO_STATE_ENTRY_FILLED = "ENTRY_FILLED"
BO_STATE_EXIT_PLACING = "EXIT_PLACING"
BO_STATE_ACTIVE = "ACTIVE"
BO_STATE_TARGET_HIT = "TARGET_HIT"
BO_STATE_SL_HIT = "SL_HIT"
BO_STATE_CANCELLED = "CANCELLED"
BO_STATE_FAILED = "FAILED"
BO_STATE_COMPLETED = "COMPLETED"

VALID_BO_STATES = [
    BO_STATE_CREATED, BO_STATE_ENTRY_PENDING, BO_STATE_ENTRY_FILLED,
    BO_STATE_EXIT_PLACING, BO_STATE_ACTIVE, BO_STATE_TARGET_HIT,
    BO_STATE_SL_HIT, BO_STATE_CANCELLED, BO_STATE_FAILED, BO_STATE_COMPLETED,
]

VALID_TARGET_SL_TYPES = ["points", "percentage", "absolute"]
