...
**Always create PRs on the origin repository (`gopinathshiva/openalgo`), NOT the upstream (`marketcalls/openalgo`).**

Use the `--repo` flag to explicitly target your repository:
```bash
gh pr create --repo gopinathshiva/openalgo --base main ...
```
...
5. **Create Pull Request**
   - Use `gh pr create --repo gopinathshiva/openalgo --base main --title "<auto-generated-title>" --body "<auto-generated-description>"`
   - The title and description should be generated based on git commit messages
   - Alternatively, use `gh pr create --repo gopinathshiva/openalgo --base main --fill` to auto-generate from commits
...
gh pr create --repo gopinathshiva/openalgo --base main --fill

# Or with custom title/description
gh pr create --repo gopinathshiva/openalgo --base main --title "Your PR Title" --body "PR description based on commits"
```
