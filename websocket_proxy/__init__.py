...
# Import the acagarwalxts_adapter
from broker.acagarwalxts.streaming.acagarwalxts_adapter import AcagarwalXTSWebSocketAdapter
...
register_adapter("acagarwalxts", AcagarwalXTSWebSocketAdapter)
