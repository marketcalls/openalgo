...
from sqlalchemy import create_engine, Column, Integer, String, BigInteger, Boolean, Date, Index
...
class Holiday(Base):
    ...
    __table_args__ = (
        Index('idx_holiday_date_year', 'holiday_date', 'year'),
    )
...
class HolidayExchange(Base):
    ...
    __table_args__ = (
        Index('idx_holiday_exchange', 'holiday_id', 'exchange_code'),
    )
...
def seed_holidays_2025():
    ...
    holidays_2025 = [
        # February
        {
            ...
            'open': [{'exchange': 'MCX', 'start_time': 1740549000000, 'end_time': 1740602700000}]  # MCX evening 17:00-23:55
        },
        # March
        {
            'date': '2025-03-14',
            ...
            'holiday_type': 'TRADING_HOLIDAY',
            'closed': ['NSE', 'BSE', 'NFO', 'BFO', 'CDS', 'BCD'],
            'open': [{'exchange': 'MCX', 'start_time': 1741964400000, 'end_time': 1742018100000}]  # MCX evening
        },
        {
            'date': '2025-03-31',
        ...
        # November - Diwali with Muhurat Trading
        {
            ...
            'open': [
                ...
                {'exchange': 'NSE', 'start_time': 1730469000000, 'end_time': 1730473500000},   # 18:00-19:15
                {'exchange': 'BSE', 'start_time': 1730469000000, 'end_time': 1730473500000},   # 18:00-19:15
                {'exchange': 'NFO', 'start_time': 1730469000000, 'end_time': 1730473500000},   # 18:00-19:15
                {'exchange': 'BFO', 'start_time': 1730469000000, 'end_time': 1730473500000},   # 18:00-19:15
                {'exchange': 'CDS', 'start_time': 1730469000000, 'end_time': 1730473500000},   # 18:00-19:15
                {'exchange': 'BCD', 'start_time': 1730469000000, 'end_time': 1730473500000},   # 18:00-19:15
                {'exchange': 'MCX', 'start_time': 1730469000000, 'end_time': 1730491500000},   # 18:00-00:15 (next day)
            ]
        },
        {
            'date': '2025-11-14',
...
def seed_holidays_2026():
    ...
    holidays_2026 = [
        ...
        },
        {
            ...
            'open': [
                # Muhurat Trading session - typically 6:00 PM to 7:15 PM IST
                {'exchange': 'NSE', 'start_time': 1761052200000, 'end_time': 1761056700000},   # 18:00-19:15
                {'exchange': 'BSE', 'start_time': 1761052200000, 'end_time': 1761056700000},   # 18:00-19:15
                {'exchange': 'NFO', 'start_time': 1761052200000, 'end_time': 1761056700000},   # 18:00-19:15
                {'exchange': 'BFO', 'start_time': 1761052200000, 'end_time': 1761056700000},   # 18:00-19:15
                {'exchange': 'CDS', 'start_time': 1761052200000, 'end_time': 1761056700000},   # 18:00-19:15
                {'exchange': 'BCD', 'start_time': 1761052200000, 'end_time': 1761056700000},   # 18:00-19:15
                {'exchange': 'MCX', 'start_time': 1761052200000, 'end_time': 1761074700000},   # 18:00-00:15 (next day)
            ]
        },
        {
            'date': '2026-10-21',
